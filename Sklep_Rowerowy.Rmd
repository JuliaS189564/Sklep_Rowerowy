...
Klienci posiadają średnio **1,46** samochodu, a odchylenie standardowe to **1.12**. Rozkład tej zmiennej jest dyskretny i **odbiega od kształtu rozkładu normalnego**. Natomiast mediana to 1, co oznacza, że większość klientów posiada przynajmniej jedno auto.

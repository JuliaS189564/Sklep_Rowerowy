...
W związku z tym, średnia arytmetyczna jako miara tendencji centralnej nie będzie reprezentatywna i konieczne będzie wykorzystanie mediany, ponieważ będzie skuteczniej odzwierciedlać typową wartość w danych.
...
hist(zbior$age, main = "Age", xlab = "Income", col = "lightblue", border = "black")
lata <- min(zbior$age)
